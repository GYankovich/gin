...
- Вверх по дереву:
  - ITEM: [[Graph/MOC ITEM — frontend-tsx — EPIC Frontend — ITEM Components]]
  - EPIC: [[Graph/MOC EPIC — frontend-tsx — EPIC Frontend]]
  - Корень: [[Graph/MOC Root — frontend-tsx]]
  - Индекс: [[Graph/Index|Graph / Index]]

Остальные заметки этого ITEM перечислены в [[Graph/MOC ITEM — frontend-tsx — EPIC Frontend — ITEM Components]] (избегаем сотен дублей ссылок в каждом файле).
