...
export const CRYPTO_UNIVERSE_FIELDS: readonly P1ScreeningFieldDef[] = [
    ...
    },
    {
        ...
        shortLabel: 'Spread',
        tooltip: 'При отборе в universe: max bid/ask спред в basis points. На входе в сделку — spread_limit_pct в «Торговой логике».',
        kind: 'integer',
        min: 0,
        step: 1,
        defaultValue: 15,
    ...
    },
    {
        ...
        label: 'Мин. ATR (%)',
        shortLabel: 'ATR min',
        tooltip: 'При отборе в universe: мин. ATR/цена кандидата. На входе в сделку — atr_period / atr_min_pct в «Торговой логике».',
        kind: 'number',
        min: 0,
        step: 0.1,
        defaultValue: 1.5,
